            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl border border-gray-100 dark:border-gray-800 overflow-hidden">
              <div className="flex items-center justify-between p-5">
                ...
                <button
                  ...
                  className={`w-14 h-8 rounded-full p-1 transition-colors ${
                    audioCues.enabled ? "bg-blue-600" : "bg-gray-300"
                  }`}
                >
                  <div
                    className={`w-6 h-6 bg-white rounded-full shadow-md transition-transform ${
                      audioCues.enabled ? "translate-x-6" : ""
                    }`}
                  ></div>
                </button>
              </div>
              ...
              <div
                className={`px-5 pb-5 space-y-4 transition-all duration-300 origin-top ${
                  audioCues.enabled
              ...
              >
                ...
                <div className="flex items-center justify-between group">
                  ...
                  <button
                    ...
                    className={`w-10 h-6 rounded-full p-0.5 transition-colors ${
                      audioCues.paceAlerts ? "bg-blue-500" : "bg-gray-300"
                    }`}
                  >
                    <div
                      className={`w-5 h-5 bg-white rounded-full shadow-sm transition-transform ${
                        audioCues.paceAlerts ? "translate-x-4" : ""
                      }`}
                    ></div>
                  </button>
                </div>
                ...
                <div className="flex items-center justify-between group">
                  ...
                  >
                    <div
                      className={`w-5 h-5 bg-white rounded-full shadow-sm transition-transform ${
                        audioCues.distanceMilestones ? "translate-x-4" : ""
                      }`}
                    ></div>
                  </button>
                </div>
